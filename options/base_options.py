...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--parallel_data', type=int, default=0, help='Decides whether to take parallel data (1) for training or to take randomly (0)')
        parser.add_argument('--single_channel', type=int, default=1, help='Decides if input images(spectrograms) are single channel (1) or not (0)')
        ...
        parser.add_argument('--fix_w', type=int, default=128, help='time frames of spec components')
