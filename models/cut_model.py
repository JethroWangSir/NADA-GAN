...
class CUTModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--noise_emb_type', type=str, default='none', help='use either none, BEATs, or reverse_SE')
    ...
    def __init__(self, opt):
        ...
        # BEATs_path ='/share/nas169/jethrowang/NADA-GAN/BEATs/BEATs_iter3_plus_AS2M_finetuned_on_AS2M_cpt2.pt'
    ...
    def forward(self):
        ...
        if self.opt.noise_emb_type == 'BEATs':
            ...
            self.trg_noise_emb = self.real_C.squeeze(1)  # [b,c,f,t] -> [b,f,t]
            # print(f'trg_noise_emb: {self.trg_noise_emb.shape}')  # [1,1,256,256] -> [1,256,256]
